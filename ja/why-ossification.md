...
ミドルボックスは、様々な目的で様々な動作をしていますが、それらはインターネット上で正常なやり取りをするために必要だと、その人が考えたから設置されている、と言ってよいでしょう。
...
プロトコルに新しい仕様が追加されたり、振る舞いが変わると、この機器には何か悪いことが起こったとか、不正な操作をされたといった、リスクと見なされることになります。
...
この硬直化と「戦う」ための真に効果的な唯一の方法は、ミドルボックスがプロトコルの詳細を見ることができないように、可能な限り通信を暗号化することなのです。
